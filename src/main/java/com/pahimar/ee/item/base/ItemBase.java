 ...
 * @since       3.0.0
 */
public class ItemBase extends Item implements IItemVariant<ItemBase> {
    ...
    public void initModels() {
        if (getCustomMeshDefinition() != null) {
            for (String variant : variants) {
                ModelBakery.registerItemVariants(this, ResourceLocationUtil.getModelResourceLocation(variant));
            }
